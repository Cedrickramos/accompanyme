...
//attractions
$stmt_a = $conn->prepare("INSERT INTO attractions (attraction_name, entrance_fee, parking, dining, operating_hours_from, operating_hours_to, contact_details, history, description, image, city_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt_a->bind_param("sssssssssss", $attraction_name, $entry_fee, $parking, $dining, $operating_hours_from, $operating_hours_to, $contact_details, $historical_significance, $description, $target_file, $city_id);

//destinations
$stmt_d = $conn->prepare("INSERT INTO destinations (attraction_name, image, map, weather, city_id) VALUES (?, ?, ?, ?, ?)");
$stmt_d->bind_param("ssssi", $attraction_name, $target_file, $map, $weather, $city_id);
